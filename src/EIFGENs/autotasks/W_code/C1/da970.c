...
extern EIF_TYPED_VALUE F970_7246(EIF_REFERENCE);
extern EIF_TYPED_VALUE F970_7247(EIF_REFERENCE);
extern EIF_TYPED_VALUE F970_7248(EIF_REFERENCE);
extern EIF_TYPED_VALUE F970_7249(EIF_REFERENCE);
extern EIF_TYPED_VALUE F970_7250(EIF_REFERENCE);
extern EIF_TYPED_VALUE F970_7251(EIF_REFERENCE);
extern EIF_TYPED_VALUE F970_7252(EIF_REFERENCE);
...
EIF_TYPED_VALUE F970_7246 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F970_7246,13525,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F970_7247)
EIF_TYPED_VALUE F970_7247 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 969, Current, 0, 0, 13525);
	RTSA(Dtype(Current));
	RTSC;
...
RTOID (F970_7248)
EIF_TYPED_VALUE F970_7248 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 969, Current, 0, 0, 13526);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
RTOID (F970_7249)
EIF_TYPED_VALUE F970_7249 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 969, Current, 0, 0, 13527);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
RTOID (F970_7250)
EIF_TYPED_VALUE F970_7250 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 969, Current, 0, 0, 13528);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F970_7251 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F970_7251,13530,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F970_7252 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F970_7252,13531,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F970_7253,13532,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit970 (void)
{
	GTCX
	RTOTS (7246,F970_7246)
	RTOTS (7247,F970_7247)
	RTOTS (7248,F970_7248)
	RTOTS (7249,F970_7249)
	RTOTS (7250,F970_7250)
	RTOTS (7251,F970_7251)
	RTOTS (7252,F970_7252)
