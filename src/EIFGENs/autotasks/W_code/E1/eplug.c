...
void egc_init_plug (void)
{
	...
	egc_system_name = "autotasks";
	egc_system_location = "C:\\Users\\Reto\\Documents\\GitHub\\sc-hs18-groupB6\\src\\EIFGENs\\autotasks\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1537855115;
...
{
	if (egc_rcdt[0] == 0) {
		egc_rcdt[0] = 1004; /* APPLICATION */
	}if (egc_rcdt[1] == 0) {
		egc_rcdt[1] = 1005; /* EQA_EVALUATOR */
	}if (egc_rcdt[2] == 0) {
		egc_rcdt[2] = 1053; /* ITP_INTERPRETER */
	}
}
